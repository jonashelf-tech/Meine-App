...
export function seedDemoSessions() {
  ...
  const demos = [
    ...
    { moduleId: 'alertness', variant: 'Ohne Ton', date: day(0), startedAt: `${day(0)}T08:47:00.000Z`, duration: 141, score: { correct: 19, errors: 0, misses: 1 }, mainMetric: 338, taps: [tap(0.35), tap(0.31), tap(0.34), tap(0.38), tap(0.30), tap(0.36), tap(0.33), tap(0.32), tap(0.35), tap(0.37), tap(0.29), tap(0.33), tap(0.36), tap(0.31), tap(0.34), tap(0.32), tap(0.35), tap(0.30), tap(0.33)] },
    // zahlensuche – 2 sessions
    { moduleId: 'zahlensuche', variant: 'Normal', date: day(5), startedAt: `${day(5)}T11:00:00.000Z`, duration: 93, score: { correct: 25, errors: 2 }, mainMetric: 93, taps: [] },
    { moduleId: 'zahlensuche', variant: 'Normal', date: day(1), startedAt: `${day(1)}T11:20:00.000Z`, duration: 81, score: { correct: 25, errors: 1 }, mainMetric: 81, taps: [] },
    ...
    { moduleId: 'gonogo', variant: 'Normal', date: day(0), startedAt: `${day(0)}T13:58:00.000Z`, duration: 174, score: { correct: 37, falseAlarms: 2, misses: 1 }, mainMetric: 278, taps: [tap(0.28), tap(0.26), tap(0.29), tap(0.27), tap(0.25), tap(0.28), tap(0.26), tap(null, false), tap(0.27), tap(0.25), tap(0.28), tap(0.26), tap(0.27)] },
    // nback – 2 sessions
    ...
    { moduleId: 'taskswitching', variant: 'Normal', date: day(0), startedAt: `${day(0)}T15:45:00.000Z`, duration: 218, score: { correct: 31, errors: 4 }, mainMetric: 138, taps: [] },
    // geteilt – 2 sessions
    ...
    { moduleId: 'geteilt', variant: 'Normal', date: day(0), startedAt: `${day(0)}T17:10:00.000Z`, duration: 171, score: { hits: 48, errors: 5 }, mainMetric: 83, taps: [] },
  ]
